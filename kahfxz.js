...
LIBRAY:  *BAILEYS MD*`, "MLBB-BOT", "List Bor ", sectionnya, { quoted: m})
break
case 'grupmenu': {
	            anu = `
  *Group Menu*
  ...
  ${prefix}demote @user
  `
  textTemplateButtons(m.chat, anu, `MLBB`, btn)
            }
break
case 'downloadmenu': {
	anu = `
...
case 'databasemenu': {
  ...
  ${prefix}delmsg
  `
  textTemplateButtons(m.chat, anu, `MLBB-BOT`, btn)
            }
break
